...
class AppVariables:
    embeddings = HuggingFaceEmbeddings(model_name="keepitreal/vietnamese-sbert", cache_folder="./backend/rag/vietnamese-sbert")
    vectorstore = Chroma(persist_directory="./backend/rag/data2", embedding_function=embeddings)
