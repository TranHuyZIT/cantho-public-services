...
\begin{minipage}{\linewidth}
    ...
    \caption{Chồng các khối Encoders và Decoders}
\end{minipage}
...
\begin{minipage}{\linewidth}
    ...
    \caption{Tầng Input và Output của Transformers}
\end{minipage}
...
\begin{minipage}{\linewidth}
    ...
    \caption{Khối ScaleDotProductAttention}
\end{minipage}
